...
static const Key keys[] = {
    ...
    {MODKEY, 0x6c4, focusstack, {.i = +1}}, // р
    {MODKEY, XKB_KEY_h, focusstack, {.i = -1}},
    {MODKEY, 0x6d2, focusstack, {.i = -1}}, // д
    ...
    // { MODKEY|WLR_MODIFIER_SHIFT, 0x6f0,              togglegaps,     {0} },
    // // П
    ...
    {0,
     0x1008ff12,
     spawn,
     {.v = SHCMD("pamixer --toggle-mute && kill -SIGUSR1 $(ps aux | grep "
                 "'[b]ash ./status.sh' | awk '{print $2}' | head -n1)")}},
    {0, 0x1008ff11, spawn, {.v = SHCMD("pamixer -d 5")}},
    {0, 0x1008ff13, spawn, {.v = SHCMD("pamixer -i 5")}},
    {0,
     0x1008ffb2,
     spawn,
     {.v = SHCMD("pactl set-source-mute @DEFAULT_SOURCE@ toggle")}},
    {0, 0x1008ff03, spawn, {.v = SHCMD("brightnessctl set 10%-")}},
    {0, 0x1008ff02, spawn, {.v = SHCMD("brightnessctl set +10%")}},
    {0,
     0xff61,
     spawn,
     {.v = SHCMD("grim -g '0,0 1920x1080' - | wl-copy & notify-send \"Скрин "
                 "сделан\"")}},
    {0,
     0xfe08,
     spawn,
     {.v = SHCMD("kill -SIGUSR1 $(ps aux | grep '[b]ash ./status.sh' | awk "
                 "'{print $2}' | head -n1)")}},
